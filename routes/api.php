...
Route::group(['prefix' => 'modules', 'as' => 'api.modules.'], function () {
    ...
    Route::apiResource('reservation-warehouse', Api\Modules\ReservationWarehouse\ReservationWarehouseController::class, ['as' => 'reservation-warehouse'])->only(['index', 'store']);
});
